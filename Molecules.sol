...
contract Benchmark {
    ...
    function rebase(uint256 supplyDelta, bool increaseSupply) external returns (uint256) {
        ...
        if (increaseSupply == true) {
            ...
            totalSupply = totalSupply.sub(uint256(supplyDelta));
        }
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        require(to != address(this),"Can't transfer to same address.");
    ...
    function transferFrom(address from, address to, uint256 value) public returns (bool) {
        require(to != address(0),"Invalid address.");
        require(to != address(this),"Can't transfer to same address.");
        require(allowedMolecules[from][msg.sender] >= value, "Allowance too low.");
